...
_ARABIC: Mapping[str, str] = {
    ...
    "language_prompt": "الأمر غير مكتمل. اختر اللغة أو اكتب en أو ar:",
    ...
    "destination_choose": "اختر مجلد التنزيل:",
    "destination_incomplete": "الأمر غير مكتمل. اختر مجلداً أو اكتب مساراً صالحاً:",
    "destination_expired": "هذا المجلد لم يعد متاحاً. استخدم /destination لتحديث الخيارات.",
    ...
    "notifications_prompt": "الأمر غير مكتمل. اختر إعداد الإشعارات:",
    "notifications_quiet_prompt": "أرسل وقت البداية والنهاية والمنطقة الزمنية، مثال: 22:00 07:00 Asia/Riyadh",
    "notifications_set": "تم تحديث تفضيلات الإشعارات.",
    "add_prompt": "الأمر غير مكتمل. أرسل الآن رابط HTTP أو HTTPS أو FTP أو magnet.",
    "follow_up_cancelled": "تم إلغاء الأمر.",
...
_ENGLISH: Mapping[str, str] = {
    ...
    "language_prompt": "That command is incomplete. Choose a language or type en or ar:",
    ...
    "destination_choose": "Choose a download destination:",
    "destination_incomplete": "That command is incomplete. Choose a folder or type a valid path:",
    "destination_expired": "That destination is no longer available. Use /destination to refresh the choices.",
    ...
    "notifications_prompt": "That command is incomplete. Choose a notification setting:",
    "notifications_quiet_prompt": "Send the start time, end time, and timezone, for example: 22:00 07:00 Asia/Riyadh",
    "notifications_set": "Notification preferences updated.",
    "add_prompt": "That command is incomplete. Send an HTTP, HTTPS, FTP, or magnet URL now.",
    "follow_up_cancelled": "Command cancelled.",
